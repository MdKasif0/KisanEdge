    ...
    <div className="flex flex-col min-h-[100dvh] bg-[#F4F8F5] font-sans relative select-none overflow-x-hidden">
      ...
      <div className="flex flex-col relative z-10 w-full max-w-md mx-auto pb-28">
        ...
        >
          ...
          {connState === "scanning" && (
            <div className="bg-amber-50/90 backdrop-blur-md px-3 py-1.5 rounded-full border border-amber-200/60 shadow-2xs flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-full bg-amber-500 animate-ping" />
              <span className="text-[12.5px] font-bold text-amber-700">Scanning</span>
            </div>
          )}

          {connState === "disconnected" && (
            <div className="bg-white/90 backdrop-blur-md px-3 py-1.5 rounded-full border border-gray-200/60 shadow-2xs flex items-center gap-1.5">
              <span className="w-2.5 h-2.5 rounded-full bg-gray-400" />
              <span className="text-[12px] font-bold text-gray-500">Offline</span>
            </div>
          )}
        </header>
        ...
        <div className="px-4 sm:px-5 mt-3 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-3xl p-4 shadow-xs border border-gray-100/90 flex flex-col gap-3">
              ...
              >
                ...
                <div className="w-13 h-13 rounded-2xl bg-[#ECFDF5] border border-emerald-100 flex items-center justify-center relative shrink-0">
                  <div className="relative">
                    ...
                    <Wifi
                      className={cn(
                        "w-3.5 h-3.5 absolute -top-1.5 -right-1.5",
                        connState === "connected"
                          ? "text-[#16A34A]"
                          : connState === "scanning"
              ...
              {connState === "connected" && (
                <div className="flex items-center gap-2 pl-2">
                  ...
                  <button
                    ...
                    title="Disconnect sensor (simulation)"
                    className="w-7 h-7 rounded-full flex items-center justify-center text-gray-300 hover:text-gray-600 hover:bg-gray-100 transition-colors ml-1 cursor-pointer"
                  >
            ...
            {connState === "disconnected" && (
              <button
                ...
                className="w-full mt-1 bg-[#0D3321] hover:bg-[#134E39] text-white rounded-2xl h-12 font-bold shadow-sm flex items-center justify-center gap-2 cursor-pointer active:scale-[0.98] transition-all text-[14.5px]"
              >
            ...
            {connState === "scanning" && (
              <div className="w-full mt-1 h-12 bg-[#ECFDF5] border border-emerald-200/80 rounded-2xl flex items-center justify-center gap-2.5 text-[#15803D] font-bold text-[14px]">
                <Search className="w-4 h-4 animate-spin text-[#16A34A]" />
          ...
          <AnimatePresence mode="wait">
            {connState === "connected" ? (
              ...
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                transition={{ duration: 0.3 }}
                className="bg-white rounded-3xl p-6 shadow-xs border border-gray-100 flex flex-col items-center text-center gap-3.5 mt-2"
              >
                <div className="w-14 h-14 rounded-2xl bg-emerald-50 text-[#16A34A] flex items-center justify-center shadow-inner">
                  <Activity className="w-7 h-7" />
                </div>
                <div className="flex flex-col gap-1 max-w-xs">
                  <h3 className="font-bold text-[#0D3321] text-[17px]">No Telemetry Stream</h3>
                ...
                <button
                  onClick={handleConnect}
                  className="mt-1 px-5 py-2.5 rounded-xl bg-[#0D3321] hover:bg-[#134E39] text-white font-bold text-[13.5px] cursor-pointer active:scale-95 transition-all shadow-sm"
                >
                  Start Simulation
                </button>
              </motion.div>
